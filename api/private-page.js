...
function transformPrivateHtml(body,mode,role='student'){
  ...
  if(mode==='admin'){
    ...
    const studentPatches=['/student-patches/questions-v2.js','/student-patches/quick-test-v2.js','/student-patches/study-tools-model-v2-loader.js?v=20260908approved2','/student-patches/central-bizu-police-news-v1.js?v=20260908a'];
...
function commonHeaders(res,mode,role='unknown'){
  ...
  res.setHeader('X-Bizu-Private-Proxy','v20-central-police-news');
...
export default async function handler(req,res){
  ...
  try{
    ...
    res.setHeader('X-Bizu-UI-Patch',mode==='admin'?'admin-management-v2+notices-stability+security-v3+student-preview-link':'shared-core-v1+questions-v2+quick-test-v2+approved-cronograma-v2+approved-cronometro-v2+central-police-news-v1+scoped-runtime');
